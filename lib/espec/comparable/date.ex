defimpl Espec.Comparable, for: Date do
  alias Espec.AmbiguousDateTime
  alias Espec.Comparable.Utils
  alias Espec.Comparable.Diff

  def compare(a, :epoch, granularity),           do: compare(a, Espec.epoch(), granularity)
  def compare(a, :zero, granularity),            do: compare(a, Espec.zero(), granularity)
